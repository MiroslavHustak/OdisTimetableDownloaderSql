...
module Messages =
    ...
    let private s1 = "Není připojení k internetu. Stahování souborů se musí ukončit, i kdyby zrovna došlo k obnovení připojení."
    let private s2 = "Zmáčknutím tlačítka Ok vypni tento program a pak jej spusť znovu."
    let internal msg17 () = sprintf "%s %s" s1 s2
    let internal msg18 = "Není připojení k internetu. Obnov jej, stahování příslušných souborů bude pak pokračovat."
